...
$(document).ready(function () {
   var image = $("#highSN");
        var imageSection = image.closest('.imageWrap');
...
$(document).ready(function () {
   var image = $("#medSN");
        ...
        // Dominant Color
        var dominantColor = getDominantColor(image);
        var dominantSwatch = imageSection.find('.dominantColor2 .swatches2');
        appendColors([dominantColor], dominantSwatch);

        // Palette
        var colorCount =image.attr('data-colorcount') ? image.data('colorcount') : 10;
        var medianPalette = createPalette(image, colorCount);
        var medianCutPalette = imageSection.find('.medianCutPalette2 .swatches2');
        appendColors(medianPalette, medianCutPalette);
});
...
$(document).ready(function () {
   var image = $("#lowSN");
        ...
        // Dominant Color
        var dominantColor = getDominantColor(image);
        var dominantSwatch = imageSection.find('.dominantColor3 .swatches3');
        appendColors([dominantColor], dominantSwatch);

        // Palette
        var colorCount =image.attr('data-colorcount') ? image.data('colorcount') : 10;
        var medianPalette = createPalette(image, colorCount);
        var medianCutPalette = imageSection.find('.medianCutPalette3 .swatches3');
        appendColors(medianPalette, medianCutPalette);
});
