...
4. `Feb  8` [__Data:__](./04/) We cover data structures, and related topics such as list traversal. We talk about how we can describe and represent data in code and images. We learn to use HTTP requests to collect remote data. _Presentations by Lorenzo and Sever_.
