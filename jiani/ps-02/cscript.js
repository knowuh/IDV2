...
for (var i = 0; i < numOfSymbols; i++) {
    var x1 = getRandomInt(0, width),
        y1 = getRandomInt(0, height)
    symbols.push({x1:x1, y1:y1, x2:x1, y2:y1+500, size:getRandomInt(0, 50), color:d3.rgb(getRandomInt(0, 255),getRandomInt(0, 255),getRandomInt(0, 255)), type:getRandomInt(0, 1)});
}
